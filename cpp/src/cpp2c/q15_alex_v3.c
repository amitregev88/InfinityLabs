...
int main()
{
    ...
    ((DerivedVTable*)((Derived*)pBase)->m_b.vptr)->vtbl.Foo(pBase);
    ((DerivedVTable*)((Derived*)pBase)->m_b.vptr)->vtbl.Dtor(pBase);
...
void* InitDerivedVTable()
{
    ...
    derivedVTable.vtbl.Foo=(void (*)(Base*))Derived_Foo;
    derivedVTable.vtbl.Dtor=(void (*)(Base*))Derived_Dtor;
